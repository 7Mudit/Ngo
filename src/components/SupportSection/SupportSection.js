  ...
  return (
    <div className='supportSection'>
        <div className='supportSection-left'>
            ...
            <p>Join our email list to get the latest UDAAN related news and updates delivered to your inbox.
            </p>
        ...
        <div className='supportSection-right'>
            ...
            <p>Your support — no matter the size — powers life-saving research and medical education, patient advocacy, and awareness for UDAAN conditions.</p>
